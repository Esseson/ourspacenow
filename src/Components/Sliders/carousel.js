...
function carousel(){
    return(
                ...
                <div id="carouselExampleControls" class="carousel slide rounded float-left pt-5 w-50 h-50 pl-5" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <img src="https://images.estately.net/89_DW18050064_0_1520146867_636x435.jpg" class="d-flex w-100" alt="house"/>
                    </div>
                    <div class="carousel-item">
                    <img src="https://images.estately.net/89_DW18050064_0_1520146867_636x435.jpg" class="d-flex w-100" alt="house"/>
                    </div>
